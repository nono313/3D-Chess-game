...
public class View extends JFrame implements PlayerListener, AbstractView
{
	...
	{		
		...
		saveMenuItem.addActionListener(new MenuListener("save"));
		loadMenuItem.addActionListener(new MenuListener("load"));
	...
	private void containersInitialization(int width, int height)
	{
		...
		/* Panel de gauche (contenant le jeu) */	
		...
		/* Panel pour le deplacement des plateaux */	
	...
	{		
		...
		{								
			...
			{			
				...
				if(j==1 || j==5)	marginRight = 20;
				else				marginRight = 0;
				if(i==6 || i==12)	marginBot = 5;
				else				marginBot = 0;
